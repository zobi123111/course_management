...
<table class="table" id="orgUnitTable">
  ...
  <tbody>
    @foreach($courses as $val)
        ...
        <td><i class="fa fa-edit edit-course-icon" style="font-size:25px; cursor: pointer;" data-orgunit-id="{{ $val->id }}" ></i></td>
        <td><i class="fa-solid fa-trash delete-icon" style="font-size:25px; cursor: pointer;" data-orgunit-id="{{ $val->id }}" ></i></td>
        </tr>
    @endforeach
  </tbody>
</table>
