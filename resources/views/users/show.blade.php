            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-md-3 text-center">
                        <img src="{{ $user->image ? asset('storage/' . $user->image) : asset('/assets/img/No_Image_Available.jpg') }}" class="rounded-circle img-thumbnail" width="150" alt="Profile Picture">
                    ...
                    <div class="col-md-9">
                        ...
                        <p><i class="bi bi-person-badge-fill text-success"></i> Role: <strong>{{ $user->roles->role_name }}</strong></p>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        @if($user->passport)
                            ...
                            <a href="{{ Storage::url($user->passport_file) }}" class="btn btn-outline-primary btn-sm" target="_blank">View File</a>
                    ...
                    <div class="col-md-6">
                        ...
                        @if($user->licence)
                            ...
                            <a href="{{ Storage::url($user->licence_file) }}" class="btn btn-outline-danger btn-sm" target="_blank">View File</a>
