            ...
            <table class="table table-hover mt-3" id="questionTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <!-- <i class="fa fa-eye action-btn" style="font-size:25px; cursor: pointer;" onclick="window.location.href='{{ route('quiz.view', ['id' => encode_id($question->id)]) }}'"></i> -->

                            <i class="fa fa-edit edit-quiz-icon action-btn" style="font-size:25px; cursor: pointer;" data-quiz-id="{{ encode_id($question->id) }}"></i>

                            <i class="fa-solid fa-trash delete-quiz-icon action-btn" style="font-size:25px; cursor: pointer;" data-quiz-id="{{ encode_id($quiz->id) }}" data-quiz-name="{{ $question->title }}" data-question-id="{{ encode_id($question->id) }}"></i>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
