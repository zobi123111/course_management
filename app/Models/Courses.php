...
class Courses extends Model
{
    ...
    protected $fillable = ['ou_id','course_type', 'course_validity', 'course_name','description','duration_type','duration_value','enable_groundschool_time', 'groundschool_hours', 'enable_simulator_time', 'simulator_hours', 'enable_custom_time_tracking', 'image','enable_feedback','enable_instructor_upload', 'status', 'enable_prerequisites', 'position', 'ato_num', 'enable_cbta','instructor_cbta','examiner_cbta', 'enable_mp_lifus', 'opc', 'opc_aircraft','opc_validity', 'opc_extend', 'archive_trainingCourse', 'auto_archive','teach_track', 'is_instructor', 'is_examiner', 'training_type', 'teach_extend_validity', 'validity'];
