...
class CourseLesson extends Model
{
    use HasFactory;
    use SoftDeletes;
    protected $fillable = ['course_id','lesson_title','description','grade_type', 'lesson_type', 'custom_time_id', 'enable_cbta', 'comment','status', 'enable_prerequisites','instructor_cbta', 'examiner_cbta', 'student_briefing','pilot_cbta'];
